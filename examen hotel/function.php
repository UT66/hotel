...
if (isset($_POST["submit"])) {
    ...
    // Hier haalt die de data van uit klant.php.
    ...
    // Hier haalt die de data van medewerker.php.
    $checkin = $_POST["startid"];
    $checkout = $_POST["endid"];
    $name = $_POST["naam"];
    $adres = $_POST["adres"];
...
//delete knop functie reserveringen
...
//edit data functie reserveringen
if (isset($_GET['edit'])) {
    $klant_id = $_GET['edit'];
    $update = true;
...
//update data functie reserveringen
...
//update data functie reserveringen
if (isset($_POST['update_mede'])) {
    $username = $row['medewerker_user'];
    $email = $row['email'];

    $mysqli->query("UPDATE medewerkers SET medewerker_user='$username', email='$email'  WHERE medewerker_id=$mede_id") or mysqli_report(MYSQLI_REPORT_ERROR | MYSQLI_REPORT_STRICT);
